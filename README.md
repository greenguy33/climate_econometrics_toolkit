...
The formula used to compute GDDs is shown below. Note that _i_ represents either a country or a grid cell, depending on the specified computation mode. D is the total number of days to be considered, which may be either all days of the year or days over a specified crop's growing season, depending on user configuration.

![Screenshot from 2025-06-15 16-11-48](https://github.com/user-attachments/assets/55574c70-0932-4186-8b3b-d1baf787feb9)
