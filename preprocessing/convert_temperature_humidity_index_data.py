...
for weight in ["unweighted","popweighted","cropweighted","maizeweighted","riceweighted","wheatweighted","soybeanweighted"]:
    ...
    pd.DataFrame.from_dict(data_dict).sort_values(["ISO3","year"]).reset_index(drop=True).to_csv(f"../src/climate_econometrics_toolkit/preprocessed_data/temperature_humidity_index/temperature_humidity_index_{weight}_1948_2024.csv")